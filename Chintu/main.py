...
class ChintuApp:
    def __init__(self):
        ...
        self.eyes = EyesEngine(self.state, CONFIG.display.width, CONFIG.display.height, CONFIG.display.fps, CONFIG.display.fullscreen)
        ...
        self.scanner = SceneScanner(Camera(), self.gemini, self.speaker, self.state)
